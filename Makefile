...
test-unit:
	...
	docker run --rm --volume ./:/opt/calc --env PYTHONPATH=/opt/calc -w /opt/calc calculator-app:latest sh -c "junit2html results/unit_result.xml results/unit_result.html"
test-behavior:
